...
class ParseSettings:
    def __init__(self,presingle,postsingle,predouble,postdouble,pretrains,posttrains) -> any:
        self.presingle=presingle
        self.postsingle=postsingle
        self.predouble=predouble
        self.postdouble=postdouble 
        self.pretrains=pretrains
        self.posttrains=posttrains
    def get(self):
        return self
